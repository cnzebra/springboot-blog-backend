package com.sonnx.blog.utils.backup;


import com.sonnx.blog.utils.backup.db.DataTable;
import com.sonnx.blog.utils.backup.db.Row;
import com.sonnx.blog.utils.backup.db.DataTable;
import com.sonnx.blog.utils.backup.db.Row;
...
public class Backup {
     ...
     */
    private final static ThreadLocal<DateFormat> DATE_FORMAT_THREAD_LOCAL = ThreadLocal.withInitial(() -> new
            SimpleDateFormat("yyy-MM-dd"));
    private final static ThreadLocal<DateFormat> DATE_TIME_FORMAT_THREAD_LOCAL = ThreadLocal.withInitial(() -> new
            SimpleDateFormat("yyy-MM-dd hh:mm:ss"));
    private final static ThreadLocal<DateFormat> TIME_FORMAT_THREAD_LOCAL = ThreadLocal.withInitial(() -> new
